...
return (
        <main className="flex justify-center w-full">
            <form className="p-2 m-4 bg-cyan-950 text-black max-w-sm w-full" onSubmit={handleSubmit}>
                <div className="mb-2">
                    <input type="text" 
                        value={name}
            ...
            <button type="submit" className="w-full mt-4 py-2 px-4 bg-teal-500 text-white rounded-lg hover:bg-teal-800">+</button>
            </form>
        </main>
);
}
